          ...
          <div className="sticky top-4 z-10 mb-6 bg-slate-800 rounded-xl border border-slate-600 p-4 flex items-center justify-between shadow-lg">
            <div className="flex items-center gap-2">
              ...
              {selectedForCompare.map(name => (
                <span key={name} className="px-2 py-1 bg-cyan-500/20 text-cyan-400 rounded text-sm">
                  {name}
                </span>
              ))}
            </div>
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
                        ...
                        <div className="text-right">
                          <div className="text-2xl font-bold text-cyan-400">{formatPrice(vehicle.price)}</div>
                      ...
                      {/* Quick Match Reasons */}
                      <div className="mb-4">
                        <h3 className="text-sm font-semibold text-amber-400 mb-2">Why This Matches You:</h3>
