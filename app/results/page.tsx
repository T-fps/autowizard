    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <p className="text-slate-500 mb-6">Take our quiz to get personalized vehicle recommendations.</p>
          <Link
            href="/quiz"
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-500 to-amber-600 text-black font-medium rounded-lg hover:from-amber-400 hover:to-amber-500 transition-colors"
              >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {selectedForCompare.length > 0 && (
          <div className="sticky top-4 z-10 mb-6 bg-white rounded-xl border border-slate-200 p-4 flex items-center justify-between shadow-lg">
            <div className="flex items-center gap-2">
              <span className="text-slate-600">
                {selectedForCompare.length} selected for comparison
              </span>
              {selectedForCompare.map(name => (
                <span key={name} className="px-2 py-1 bg-amber-100 text-amber-700 rounded text-sm">
                  {name}
                </span>
              ))}
            </div>
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
                        ...
                        <div className="text-right">
                          <div className="text-2xl font-bold text-amber-600">{formatPrice(vehicle.price)}</div>
                      ...
                      <div className="flex flex-wrap gap-3">
                        <Link
                          ...
                          className="px-4 py-2 bg-gradient-to-r from-amber-500 to-amber-600 text-black font-medium rounded-lg hover:from-amber-400 hover:to-amber-500 transition-all text-sm"
                        >
                          View Details
                        </Link>
                        <button
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 px-4 py-2 text-slate-500 hover:text-amber-600 transition-colors text-sm"
                        >
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {vehicle.features.slice(0, 8).map(feature => (
                            <span 
                              key={feature}
                              className="px-3 py-1 bg-slate-100 text-slate-600 rounded-full text-sm capitalize border border-slate-200"
                            >
                              {feature.replace(/-/g, ' ')}
                            </span>
                          ))}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {vehicle.useCases.map(useCase => (
                            <span 
                              key={useCase}
                              className="px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-sm capitalize"
                            >
                              {useCase}
                            </span>
                          ))}
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-50 rounded-xl border border-slate-200 p-6 text-center">
            ...
            <p className="text-slate-500 text-sm mb-4">Adjust your preferences and see new recommendations.</p>
            <Link
              href="/quiz"
              className="inline-flex items-center px-6 py-3 bg-slate-100 text-slate-900 font-medium rounded-lg hover:bg-slate-200 transition-colors border border-slate-200"
            >
              Retake Quiz
            </Link>
          </div>
          ...
          {/* Save Results */}
          <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 rounded-xl border border-amber-200 p-6 text-center">
            ...
            <p className="text-slate-500 text-sm mb-4">Email yourself these recommendations to review later.</p>
            <button
              onClick={handleEmailResults}
        ...
        <div className="mt-12 bg-slate-50 rounded-xl border border-slate-200 p-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/best/suvs" className="px-4 py-2 bg-white text-slate-700 rounded-lg hover:bg-amber-50 hover:text-amber-700 transition-colors border border-slate-200">
              Browse All SUVs
            </Link>
            <Link href="/best/trucks" className="px-4 py-2 bg-white text-slate-700 rounded-lg hover:bg-amber-50 hover:text-amber-700 transition-colors border border-slate-200">
              Browse All Trucks
            </Link>
            <Link href="/best/sedans" className="px-4 py-2 bg-white text-slate-700 rounded-lg hover:bg-amber-50 hover:text-amber-700 transition-colors border border-slate-200">
              Browse All Sedans
            </Link>
            <Link href="/best/electric" className="px-4 py-2 bg-white text-slate-700 rounded-lg hover:bg-amber-50 hover:text-amber-700 transition-colors border border-slate-200">
              Electric Vehicles
            </Link>
            <Link href="/brands" className="px-4 py-2 bg-white text-slate-700 rounded-lg hover:bg-amber-50 hover:text-amber-700 transition-colors border border-slate-200">
              Browse by Brand
            </Link>
          </div>
        </div>
