      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/10 border border-amber-500/20 rounded-full mb-6">
            ...
            <span className="text-amber-400 text-sm font-medium">Your Car Research Hub</span>
          </div>
          ...
          {quickLinks.map((link) => (
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className={`text-xl font-bold mb-2 ${link.featured ? link.textColor : 'text-white'}`}>{link.title}</h3>
                <p className={`text-sm ${link.featured ? 'text-black/70' : 'text-white/60'}`}>{link.description}</p>
              </div>
              {link.featured && (
        ...
        <section className="mb-16">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/blog" className="text-amber-400 hover:text-amber-300 text-sm font-medium flex items-center gap-1">
        ...
        <section className="mb-16">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-white">🏷️ Popular Brands</h2>
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-white/10 rounded-2xl p-6">
            ...
            <p className="text-white/60 mb-4">Quick access to the most searched vehicles.</p>
            <div className="flex flex-wrap gap-3">
