        ...
        <div className="max-w-7xl mx-auto px-6 py-2">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 items-center gap-2">
              <Link href="/" className="px-4 py-2 rounded-lg text-white font-bold hover:text-amber-400 hover:bg-white/5 transition-all">Wizard&apos;s Guide</Link>
              ...
              <Link href="/about" className="px-4 py-2 rounded-lg text-white font-bold hover:text-amber-400 hover:bg-white/5 transition-all">About Us</Link>
            </nav>
          ...
          <nav className="md:hidden flex items-center justify-center gap-2 mt-3 pt-3 border-t border-white/10">
            <Link href="/" className="px-3 py-1.5 rounded-lg text-sm text-white font-bold hover:text-amber-400 hover:bg-white/5 transition-all">Wizard&apos;s Guide</Link>
            ...
            <Link href="/about" className="px-3 py-1.5 rounded-lg text-sm text-white font-bold hover:text-amber-400 hover:bg-white/5 transition-all">About</Link>
          </nav>
        </div>
      </header>
