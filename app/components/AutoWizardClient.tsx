...
export default function AutoWizard() {
  ...
  // Vehicle images - using Wikipedia API for free, accurate images
  // We'll cache fetched URLs to avoid repeated API calls
  ...
  const getWikipediaTitle = (vehicle: string): string => {
    ...
    const titleMappings: Record<string, string> = {
      ...
      'Nissan 370Z': 'Nissan_370Z',
      'Nissan GT-R': 'Nissan_GT-R',
      'Mazda3': 'Mazda3',
      'Mazda CX-5': 'Mazda_CX-5',
      'Mazda CX-9': 'Mazda_CX-9',
  ...
  // Get vehicle image URL (cached or fallback)
  const getVehicleImage = (vehicle: string): string => {
    // Trigger fetch if not already cached or loading
    if (!imageCache[vehicle] && !loadingImages.has(vehicle)) {
    ...
    // Return a stylish fallback placeholder
  ...
  // Load images for recommended vehicles when results are available
  useEffect(() => {
    if (result?.vehicles) {
        ...
        <div className="relative">
          <section className="relative max-w-7xl mx-auto px-6 pt-20 pb-16">
            <div className="relative text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-white/60 mb-12 max-w-2xl mx-auto">Our quick and easy vehicle matching assessment analyzes your lifestyle, needs, and preferences to match you with the car of your dreams from 16 categories and 300+ models.</p>
            ...
            <div className="relative mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
              {[{ value: allQuestions.length.toString(), label: 'Questions', icon: Target }, { value: '16', label: 'Categories', icon: CarFront }, { value: '300+', label: 'Models', icon: Gauge }, { value: '100%', label: 'Free', icon: Heart }].map((s, i) => (
          ...
          <article className="prose prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-amber-500/20 to-amber-600/10 border border-amber-500/30 rounded-2xl p-8 mb-12 text-center">
              ...
              <p className="text-white/70 mb-6 max-w-xl mx-auto">
                Our free 3-5 minute quiz analyzes your lifestyle, budget, and preferences to match you with the perfect vehicle from 300+ models.
              </p>
              <button 
                onClick={startTest}
