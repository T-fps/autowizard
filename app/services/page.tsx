        ...
        <div className="space-y-6">
          <div className="p-8 rounded-2xl bg-zinc-900/50 border border-white/10">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-xl font-semibold text-amber-400 mb-2">Expert Consultation</h2>
                <p className="text-white/60">One-on-one sessions with certified automotive specialists</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-white/10">
              ...
              <Link href="/consultation" className="px-6 py-2 rounded-lg bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 transition-all">Book Now</Link>
            </div>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-zinc-900/50 border border-white/10">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-xl font-semibold text-amber-400 mb-2">Customization Support</h2>
                <p className="text-white/60">Personalize your vehicle with expert guidance</p>
              </div>
            </div>
            <ul className="space-y-3 mb-6">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-white/10">
              ...
              <Link href="/consultation" className="px-6 py-2 rounded-lg bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 transition-all">Get Started</Link>
            </div>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-zinc-900/50 border border-white/10">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-xl font-semibold text-amber-400 mb-2">Purchase Assistance</h2>
                <p className="text-white/60">Navigate the buying process with confidence</p>
              </div>
            </div>
            <ul className="space-y-3 mb-6">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-white/10">
              ...
              <Link href="/consultation" className="px-6 py-2 rounded-lg bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 transition-all">Learn More</Link>
            </div>
          </div>
        </div>
      </div>
