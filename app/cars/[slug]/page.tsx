                ...
                <div className="mt-6 pt-6 border-t border-slate-700">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {vehicle.powertrain === 'hybrid' && (
                      <span className="px-3 py-1.5 bg-green-500/20 text-green-400 rounded-full text-sm font-medium">🔋 Hybrid</span>
                    )}
                    {vehicle.powertrain === 'phev' && (
                      <>
                        <span className="px-3 py-1.5 bg-green-500/20 text-green-400 rounded-full text-sm font-medium">🔌 Plug-in Hybrid</span>
                        <span className="px-3 py-1.5 bg-orange-500/20 text-orange-400 rounded-full text-sm font-medium">⛽ Gas</span>
                      </>
                    )}
                    {vehicle.powertrain === 'ev' && (
                      <span className="px-3 py-1.5 bg-cyan-500/20 text-cyan-400 rounded-full text-sm font-medium">⚡ Electric</span>
                    )}
                    ...
                    {(vehicle.features.includes('awd') || vehicle.features.includes('awd-available')) && (
                      <span className="px-3 py-1.5 bg-blue-500/20 text-blue-400 rounded-full text-sm font-medium">AWD</span>
                    )}
                    {(vehicle.features.includes('4wd') || vehicle.features.includes('offroad') || vehicle.bodyType === 'truck') && (
                      <span className="px-3 py-1.5 bg-amber-500/20 text-amber-400 rounded-full text-sm font-medium">4WD</span>
                    )}
