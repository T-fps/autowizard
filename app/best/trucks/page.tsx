    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-2">
          {vehicle.features.includes('towing') && (
            <span className="px-2 py-1 bg-amber-500/20 text-amber-400 rounded text-xs">Towing</span>
          )}
          {vehicle.features.includes('offroad') && (
            <span className="px-2 py-1 bg-orange-500/20 text-orange-400 rounded text-xs">Off-Road</span>
          )}
          {vehicle.powertrain === 'ev' && (
            <span className="px-2 py-1 bg-green-500/20 text-green-400 rounded text-xs">Electric</span>
          )}
        </div>
      </div>
    </Link>
