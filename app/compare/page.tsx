                ...
                >
                  {vehicle && vehicleData ? (
                    <>
                      ...
                      <p className="text-cyan-400 text-sm">{formatPrice(vehicleData.price)}</p>
                      <p className="text-slate-400 text-xs">{getBodyTypeDisplay(vehicleData.bodyType)}</p>
                    </>
                  ) : (
                    <button
                      onClick={() => setShowSearch(true)}
                      className="w-full h-full flex flex-col items-center justify-center text-slate-400 hover:text-cyan-400 transition-colors"
                    >
            ...
            {popularComparisons.map((comparison) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-3 text-cyan-400 text-sm flex items-center gap-1">
