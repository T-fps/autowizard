...
// Brand logo URLs (using Car Logos API / brand websites)
const brandLogos: Record<string, string> = {
  ...
  'Ferrari': 'https://www.carlogos.org/car-logos/ferrari-logo-1947.png',
  'Lamborghini': 'https://www.carlogos.org/car-logos/lamborghini-logo-1998.png',
  'McLaren': 'https://www.carlogos.org/car-logos/mclaren-logo-2002.png',
  'Aston Martin': 'https://www.carlogos.org/car-logos/aston-martin-logo-2021.png',
  'Bentley': 'https://www.carlogos.org/car-logos/bentley-logo-2002.png',
  'Rolls-Royce': 'https://www.carlogos.org/car-logos/rolls-royce-logo-2020.png',
  'Bugatti': 'https://www.carlogos.org/car-logos/bugatti-logo-2022.png',
  'Maserati': 'https://www.carlogos.org/car-logos/maserati-logo-2020.png',
  'Lotus': 'https://www.carlogos.org/car-logos/lotus-logo-2019.png',
  'Pagani': 'https://www.carlogos.org/car-logos/pagani-logo-1998.png',
  'Koenigsegg': 'https://www.carlogos.org/car-logos/koenigsegg-logo-2011.png',
  ...
  'Ram': 'https://www.carlogos.org/car-logos/ram-logo-2009.png',
  ...
  'Acura': 'https://www.carlogos.org/car-logos/acura-logo-2006.png',
  'Infiniti': 'https://www.carlogos.org/car-logos/infiniti-logo-1989.png',
  'Rivian': 'https://www.carlogos.org/car-logos/rivian-logo-2018.png',
  'Lucid': 'https://www.carlogos.org/car-logos/lucid-motors-logo-2020.png',
  ...
  'Alfa Romeo': 'https://www.carlogos.org/car-logos/alfa-romeo-logo-2015.png',
};
        ...
        <div className={`relative bg-gradient-to-br ${brandColor.gradient} border-b border-slate-700`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="flex items-center gap-6 mb-6">
              {logoUrl && (
                <div className="w-20 h-20 md:w-28 md:h-28 bg-white/10 backdrop-blur-sm rounded-2xl p-3 flex items-center justify-center border border-white/20">
                  <BrandLogo 
                    src={logoUrl} 
                    alt={`${name} logo`}
                  />
            ...
            <div key={type} className="mb-12">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {vehiclesByType[type].map(vehicle => (
                  ...
                  >
                    <div className={`aspect-video bg-gradient-to-br ${brandColor.gradient} flex items-center justify-center relative overflow-hidden`}>
                      <CarImage 
                      ...
                      {vehicle.segment === 'exotic' && (
                        <div className="absolute top-2 right-2 bg-gradient-to-r from-amber-500 to-red-500 text-white px-2 py-0.5 rounded-full text-xs font-bold">
                          EXOTIC
                        </div>
                      )}
                    </div>
