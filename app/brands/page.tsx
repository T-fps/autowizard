...
const brandCategories = {
  ...
  'Electric': ['Tesla', 'Rivian', 'Lucid', 'Polestar'],
  'European': ['BMW', 'Mercedes-Benz', 'Audi', 'Porsche', 'Volvo', 'Volkswagen', 'Jaguar', 'Land Rover', 'Alfa Romeo', 'Maserati'],
  'Japanese': ['Toyota', 'Honda', 'Nissan', 'Mazda', 'Subaru', 'Lexus', 'Acura', 'Infiniti'],
  'Korean': ['Hyundai', 'Kia', 'Genesis'],
  'Exotic': ['Ferrari', 'Lamborghini', 'McLaren', 'Aston Martin', 'Bentley', 'Rolls-Royce', 'Bugatti'],
};
