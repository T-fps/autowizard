        ...
        <section className="relative max-w-7xl mx-auto px-6 pt-20 pb-16">
          <div className="relative text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-white/60 mb-12 max-w-2xl mx-auto">
              Our quick and easy vehicle matching assessment analyzes your lifestyle, needs, and preferences to match you with the car of your dreams from 16 categories and 300+ models.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link 
                href="/guide" 
                className="px-8 py-4 rounded-xl bg-white text-black text-lg font-semibold hover:bg-white/90 transition-all flex items-center justify-center gap-2"
              >
                Wizard&apos;s Guide <span className="text-xl">›</span>
              </Link>
            </div>
          </div>
          ...
          <div className="relative mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { value: '300+', label: 'Models', icon: Gauge },
