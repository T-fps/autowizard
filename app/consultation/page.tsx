      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
          ...
          <div className="space-y-6">
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-xl border transition-all text-left flex items-center gap-3 ${selected ? 'bg-amber-500/15 border-amber-500/60' : 'bg-black/30 border-white/10 hover:border-amber-500/40'}`}
                    >
            ...
            <div>
              ...
              <div className="flex gap-3 mb-3">
                ...
                <button
                  ...
                  className="px-4 py-3 rounded-xl bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 transition-all"
                >
                  Add Date
                </button>
              </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {consultForm.dates.map((date, i) => (
                    <div key={i} className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-amber-500/15 border border-amber-500/30">
                      ...
                      <button onClick={() => removeDate(date)} className="text-amber-400/60 hover:text-amber-400">
                        <X className="w-4 h-4" />
                      </button>
                    </div>
                  ))}
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-xl border transition-all text-center ${selected ? 'bg-amber-500/15 border-amber-500/60' : 'bg-black/30 border-white/10 hover:border-amber-500/40'}`}
                    >
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-white/70">Notes</label>
              <textarea
